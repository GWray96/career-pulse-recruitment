        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <article key={post.slug} className="group bg-white rounded-xl shadow-soft overflow-hidden transition-all duration-150 ease-out hover:shadow-xl hover:-translate-y-1">
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent transition-opacity duration-150 ease-out"></div>
                  <div className="absolute top-4 left-4">
                    <span className="inline-block px-3 py-1 text-xs font-semibold text-white bg-primary/90 backdrop-blur-sm rounded-full shadow-lg transition-transform duration-150 ease-out group-hover:scale-105">
                      {post.category}
                    </span>
                  </div>
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-deep-charcoal mb-3 transition-colors duration-150 ease-out group-hover:text-primary">
                    <Link href={`/blog/${post.slug}`} className="hover:text-primary transition-colors duration-150 ease-out">
                      {post.title}
                    </Link>
                  </h3>
                  ...
                  <Link 
                    href={`/blog/${post.slug}`}
                    className="inline-flex items-center text-primary font-medium hover:text-primary-dark transition-colors duration-150 ease-out group/link"
                  >
                    Read More
                    <svg className="ml-2 w-4 h-4 transform transition-transform duration-150 ease-out group-hover/link:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                    </svg>
                  </Link>
                </div>
