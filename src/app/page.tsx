    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-primary-50">
      ...
      <section className="relative min-h-[600px] flex items-center">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-r from-deep-charcoal/90 to-deep-charcoal/70 z-10" />
          <Image
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="max-w-3xl">
            ...
            >
              Transform Your Career Journey with Career Pulse
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                href="/jobs"
                className="inline-flex items-center justify-center px-8 py-4 bg-primary text-white rounded-full text-lg font-medium hover:bg-primary/90 transition-colors duration-300 shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30"
              >
                Find Your Next Role
              </Link>
              <Link
                href="/employers"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-deep-charcoal rounded-full text-lg font-medium hover:bg-white/90 transition-colors duration-300 shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-black/20"
              >
                For Employers
              </Link>
            </motion.div>
          ...
          <motion.div 
            ...
            className="absolute right-8 top-1/2 -translate-y-1/2 hidden lg:block max-w-sm bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20"
          >
            ...
            <p className="text-white/90 italic">
              "Career Pulse transformed my job search. Their AI-powered matching found me the perfect role in just two weeks!"
            </p>
          </motion.div>
        </div>
      </section>
