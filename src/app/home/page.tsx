              ...
              <div className="w-full md:w-1/2 md:pl-12">
                <div className="relative">
                  ...
                  <div className="relative bg-white p-8 rounded-2xl shadow-lg border border-blue-100">
                    <h4 className="text-xl font-semibold mb-4 text-blue-600">Sales-Specific Expertise</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">✓</span>
                        <span className="text-blue-700">Deep understanding of sales roles and requirements</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">✓</span>
                        <span className="text-blue-700">Industry-specific assessment techniques</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">✓</span>
                        <span className="text-blue-700">Specialized networks in sales communities</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="w-full md:w-1/2 md:order-1 md:pr-12">
                <div className="relative">
                  ...
                  <div className="relative bg-white p-8 rounded-2xl shadow-lg border border-green-100">
                    <h4 className="text-xl font-semibold mb-4 text-green-600">Our Matching Process</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <span className="text-green-500 mr-2 mt-1">✓</span>
                        <span className="text-green-700">Comprehensive candidate profiling</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-500 mr-2 mt-1">✓</span>
                        <span className="text-green-700">Detailed company culture assessment</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-500 mr-2 mt-1">✓</span>
                        <span className="text-green-700">Skill and experience alignment</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="w-full md:w-1/2 md:pl-12">
                <div className="relative">
                  ...
                  <div className="relative bg-white p-8 rounded-2xl shadow-lg border border-purple-100">
                    <h4 className="text-xl font-semibold mb-4 text-purple-600">Market Intelligence</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <span className="text-purple-500 mr-2 mt-1">✓</span>
                        <span className="text-purple-700">Regular salary and compensation reports</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-purple-500 mr-2 mt-1">✓</span>
                        <span className="text-purple-700">Industry trend analysis and forecasting</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-purple-500 mr-2 mt-1">✓</span>
                        <span className="text-purple-700">Competitive landscape insights</span>
                      </li>
                    </ul>
                  </div>
                </div>
