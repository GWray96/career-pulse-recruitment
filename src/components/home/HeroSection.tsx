            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12">
              <div className="w-full lg:w-1/2 mb-6 sm:mb-8 lg:mb-0">
                <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold text-white leading-tight mb-3 sm:mb-4">
                  Flat Fee Recruitment <span className="text-pulse-orange animate-pulse-heartbeat inline-block overflow-visible px-1">That Delivers</span>
                </h1>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12">
              <div className="w-full lg:w-1/2 mb-8 sm:mb-10 lg:mb-0">
                <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold text-white leading-tight mb-4 sm:mb-6">
                  Your Career <span className="text-pulse-orange animate-pulse-heartbeat inline-block overflow-visible px-1">Accelerated</span>
                </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-10">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/20 transform transition-all duration-300 hover:scale-105 hover:bg-white/15">
                    <div className="flex items-center mb-2 sm:mb-3">
                      ...
                      <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white">Job Matching</h3>
                    </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/20 transform transition-all duration-300 hover:scale-105 hover:bg-white/15">
                    <div className="flex items-center mb-2 sm:mb-3">
                      ...
                      <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white">Career Coaching</h3>
                    </div>
                    <p className="text-xs sm:text-sm text-white/80 mb-3 sm:mb-4">
                ...
                <div className="relative w-full max-w-sm md:max-w-md lg:mr-4 xl:mr-8">
                  ...
                  <div className="relative bg-white rounded-xl shadow-xl sm:shadow-2xl overflow-hidden">
                    <div className="bg-primary-50 p-3 sm:p-4 border-b border-gray-100">
                      <div className="flex justify-between items-center">
                        <h3 className="font-bold text-sm sm:text-base text-deep-navy">Career Growth</h3>
                      ...
                      <div className="mb-4 sm:mb-6">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          <div className="flex items-start">
                            ...
                            <div>
                              <div className="font-medium text-sm sm:text-base text-charcoal-grey">Resume Optimization</div>
                              <p className="text-xs sm:text-sm text-light-grey">Get your CV noticed by top employers with our expert optimization tips.</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              <div className="font-medium text-sm sm:text-base text-charcoal-grey">Interview Preparation</div>
                              <p className="text-xs sm:text-sm text-light-grey">Personalized coaching to help you stand out and impress employers.</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              <div className="font-medium text-sm sm:text-base text-charcoal-grey">Salary Negotiation</div>
                              <p className="text-xs sm:text-sm text-light-grey">Get the compensation you deserve with our negotiation strategies.</p>
                            </div>
                          </div>
                        </div>
                      </div>
